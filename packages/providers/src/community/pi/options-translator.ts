...
// Skill resolution is shared across providers. Pi re-exports the shared
// implementation under its historical name to avoid churning callers and
// tests; new providers should import `resolveSkillDirectories` directly
// from `../../shared/skills`.
export {
  resolveSkillDirectories as resolvePiSkills,
  type ResolvedSkills,
} from '../../shared/skills';
